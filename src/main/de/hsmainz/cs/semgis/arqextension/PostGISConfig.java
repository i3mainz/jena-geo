...
public class PostGISConfig {
    ...
    public static final void setup() {
        ...
        if (!IS_FUNCTIONS_REGISTERED) {
            ...
            functionRegistry.put(PostGISGeo.st_addgeometry.getURI(), AddGeometry.class);
            functionRegistry.put(PostGISGeo.st_addpoint.getURI(), AddPoint.class);
            functionRegistry.put(PostGISGeo.st_addRing.getURI(), AddRing.class);
            functionRegistry.put(PostGISGeo.st_addz.getURI(), AddZ.class);
            functionRegistry.put(PostGISGeo.st_angle.getURI(), Angle.class);
            ...
            functionRegistry.put(PostGISGeo.st_circularity.getURI(), CircularityIndex.class);
            functionRegistry.put(PostGISGeo.st_clipByBox2D.getURI(), ClipByBox2D.class);
            functionRegistry.put(PostGISGeo.st_closestCooordinate.getURI(), ClosestCoordinate.class);
            ...
            functionRegistry.put(PostGISGeo.st_dumpRings.getURI(), DumpRings.class);
            ...
            functionRegistry.put(PostGISGeo.st_ensureClosed.getURI(), EnsureClosed.class);
            ...
            functionRegistry.put(PostGISGeo.st_equalType.getURI(), EqualType.class);
            ...
            functionRegistry.put(PostGISGeo.st_intersectionMatrix.getURI(), IntersectionMatrix.class);
            ...
            functionRegistry.put(PostGISGeo.st_isAcute.getURI(), IsAcute.class);
            ...
            functionRegistry.put(PostGISGeo.st_isEquilateralTriangle.getURI(), IsEquilateralTriangle.class);
            ...
            functionRegistry.put(PostGISGeo.st_isPlanar.getURI(), IsPlanar.class);
            ...
            functionRegistry.put(PostGISGeo.st_isRectangle.getURI(), IsRectangle.class);
            ...
            functionRegistry.put(PostGISGeo.st_isSolid.getURI(), IsSolid.class);
            functionRegistry.put(PostGISGeo.st_isSquare.getURI(), IsSquare.class);
            ...
            functionRegistry.put(PostGISGeo.st_rast_algebra_add.getURI(), de.hsmainz.cs.semgis.arqextension.raster.algebra.Add.class);
            functionRegistry.put(PostGISGeo.st_rast_algebra_addconst.getURI(), de.hsmainz.cs.semgis.arqextension.raster.algebra.AddConst.class);
            functionRegistry.put(PostGISGeo.st_rast_algebra_and.getURI(), de.hsmainz.cs.semgis.arqextension.raster.algebra.And.class);
            functionRegistry.put(PostGISGeo.st_rast_algebra_andconst.getURI(), de.hsmainz.cs.semgis.arqextension.raster.algebra.AndConst.class);
            functionRegistry.put(PostGISGeo.st_rast_algebra_binarize.getURI(), de.hsmainz.cs.semgis.arqextension.raster.algebra.Binarize.class);
            functionRegistry.put(PostGISGeo.st_rast_algebra_clamp.getURI(), de.hsmainz.cs.semgis.arqextension.raster.algebra.Clamp.class);
            functionRegistry.put(PostGISGeo.st_rast_algebra_constant.getURI(), de.hsmainz.cs.semgis.arqextension.raster.algebra.Constant.class);
            functionRegistry.put(PostGISGeo.st_rast_algebra_crop.getURI(), de.hsmainz.cs.semgis.arqextension.raster.algebra.Crop.class);
            functionRegistry.put(PostGISGeo.st_rast_algebra_dct.getURI(), de.hsmainz.cs.semgis.arqextension.raster.algebra.DCT.class);
            functionRegistry.put(PostGISGeo.st_rast_algebra_div.getURI(), de.hsmainz.cs.semgis.arqextension.raster.algebra.Div.class);
            functionRegistry.put(PostGISGeo.st_rast_algebra_exp.getURI(), de.hsmainz.cs.semgis.arqextension.raster.algebra.Exp.class);
            functionRegistry.put(PostGISGeo.st_rast_algebra_divconst.getURI(), de.hsmainz.cs.semgis.arqextension.raster.algebra.DivConst.class);
            functionRegistry.put(PostGISGeo.st_rast_algebra_idct.getURI(), de.hsmainz.cs.semgis.arqextension.raster.algebra.IDCT.class);
            functionRegistry.put(PostGISGeo.st_rast_algebra_log.getURI(), de.hsmainz.cs.semgis.arqextension.raster.algebra.Log.class);
            functionRegistry.put(PostGISGeo.st_rast_algebra_max.getURI(), de.hsmainz.cs.semgis.arqextension.raster.algebra.Max.class);
            functionRegistry.put(PostGISGeo.st_rast_algebra_maxfilter.getURI(), de.hsmainz.cs.semgis.arqextension.raster.algebra.MaxFilter.class);
            functionRegistry.put(PostGISGeo.st_rast_algebra_mean.getURI(), de.hsmainz.cs.semgis.arqextension.raster.algebra.Mean.class);
            functionRegistry.put(PostGISGeo.st_rast_algebra_medianfilter.getURI(), de.hsmainz.cs.semgis.arqextension.raster.algebra.MedianFilter.class);
            functionRegistry.put(PostGISGeo.st_rast_algebra_min.getURI(), de.hsmainz.cs.semgis.arqextension.raster.algebra.Min.class);
            functionRegistry.put(PostGISGeo.st_rast_algebra_minfilter.getURI(), de.hsmainz.cs.semgis.arqextension.raster.algebra.MinFilter.class);
            functionRegistry.put(PostGISGeo.st_rast_algebra_mult.getURI(), de.hsmainz.cs.semgis.arqextension.raster.algebra.Mult.class);
            functionRegistry.put(PostGISGeo.st_rast_algebra_multconst.getURI(), de.hsmainz.cs.semgis.arqextension.raster.algebra.MultConst.class);
            functionRegistry.put(PostGISGeo.st_rast_algebra_not.getURI(), de.hsmainz.cs.semgis.arqextension.raster.algebra.Not.class);
            functionRegistry.put(PostGISGeo.st_rast_algebra_or.getURI(), de.hsmainz.cs.semgis.arqextension.raster.algebra.Or.class);
            functionRegistry.put(PostGISGeo.st_rast_algebra_orconst.getURI(), de.hsmainz.cs.semgis.arqextension.raster.algebra.OrConst.class);
            functionRegistry.put(PostGISGeo.st_rast_algebra_subtract.getURI(), de.hsmainz.cs.semgis.arqextension.raster.algebra.Subtract.class);
            functionRegistry.put(PostGISGeo.st_rast_algebra_subtractconst.getURI(), de.hsmainz.cs.semgis.arqextension.raster.algebra.SubtractConst.class);
            functionRegistry.put(PostGISGeo.st_rast_algebra_subtractfromconst.getURI(), de.hsmainz.cs.semgis.arqextension.raster.algebra.SubtractFromConst.class);
            functionRegistry.put(PostGISGeo.st_rast_algebra_threshold.getURI(), de.hsmainz.cs.semgis.arqextension.raster.algebra.Threshold.class);
            functionRegistry.put(PostGISGeo.st_rast_algebra_xor.getURI(), de.hsmainz.cs.semgis.arqextension.raster.algebra.Xor.class);
            functionRegistry.put(PostGISGeo.st_rast_algebra_xorconst.getURI(), de.hsmainz.cs.semgis.arqextension.raster.algebra.XorConst.class);
            ...
            functionRegistry.put(PostGISGeo.st_rast_srid.getURI(), de.hsmainz.cs.semgis.arqextension.raster.transform.SRID.class);
            ...
            functionRegistry.put(PostGISGeo.st_removegeometry.getURI(), RemoveGeometry.class);
            ...
            functionRegistry.put(PostGISGeo.st_removeRing.getURI(), RemoveRing.class);
            ...
            functionRegistry.put(PostGISGeo.st_reverseRing.getURI(), ReverseRing.class);
            ...
            functionRegistry.put(PostGISGeo.st_selfIntersections.getURI(), SelfIntersections.class);
            functionRegistry.put(PostGISGeo.st_setEndPoint.getURI(), SetEndPoint.class);
            functionRegistry.put(PostGISGeo.st_setGeometry.getURI(), SetGeometry.class);
            functionRegistry.put(PostGISGeo.st_setPoint.getURI(), SetPoint.class);
            functionRegistry.put(PostGISGeo.st_setRing.getURI(), SetRing.class);
            functionRegistry.put(PostGISGeo.st_setStartPoint.getURI(), SetStartPoint.class);
            ...
            functionRegistry.put(PostGISGeo.st_summaryStats.getURI(), SummaryStats.class);
           ...
           // functionRegistry.put(PostGISGeo.st_vectorize.getURI(), Vectorize.class);
            ...
            functionRegistry.put(PostGISGeo.centimeterToMeter.getURI(), CentimeterToMeter.class);
            functionRegistry.put(PostGISGeo.chainToMeter.getURI(), ChainToMeter.class);
            functionRegistry.put(PostGISGeo.decimeterToMeter.getURI(), DecimeterToMeter.class);
            functionRegistry.put(PostGISGeo.fathomToMeter.getURI(), FathomToMeter.class);
            functionRegistry.put(PostGISGeo.footToMeter.getURI(), FootToMeter.class);
            functionRegistry.put(PostGISGeo.inchToMeter.getURI(), InchToMeter.class);
            functionRegistry.put(PostGISGeo.kilometerToMeter.getURI(), KilometerToMeter.class);
            functionRegistry.put(PostGISGeo.linkToMeter.getURI(), LinkToMeter.class);
            functionRegistry.put(PostGISGeo.meterToCentimeter.getURI(), MeterToCentimeter.class);
            functionRegistry.put(PostGISGeo.meterToChain.getURI(), MeterToChain.class);
            functionRegistry.put(PostGISGeo.meterToDecimeter.getURI(), MeterToDecimeter.class);
            functionRegistry.put(PostGISGeo.meterToFathom.getURI(), MeterToFathom.class);
            functionRegistry.put(PostGISGeo.meterToFoot.getURI(), MeterToFoot.class);
            functionRegistry.put(PostGISGeo.meterToInch.getURI(), MeterToInch.class);
            functionRegistry.put(PostGISGeo.meterToKilometer.getURI(), MeterToKilometer.class);
            functionRegistry.put(PostGISGeo.meterToLink.getURI(), MeterToLink.class);
            functionRegistry.put(PostGISGeo.meterToMile.getURI(), MeterToMile.class);
            functionRegistry.put(PostGISGeo.meterToMillimeter.getURI(), MeterToMillimeter.class);
            functionRegistry.put(PostGISGeo.meterToNauticalMile.getURI(), MeterToNauticalMile.class);
            functionRegistry.put(PostGISGeo.meterToUSFoot.getURI(), MeterToUSFoot.class);
            functionRegistry.put(PostGISGeo.meterToUSInch.getURI(), MeterToUSInch.class);
            functionRegistry.put(PostGISGeo.meterToUSMile.getURI(), MeterToUSMile.class);
            functionRegistry.put(PostGISGeo.meterToUSYard.getURI(), MeterToUSYard.class);
            functionRegistry.put(PostGISGeo.mileToMeter.getURI(), MileToMeter.class);
            functionRegistry.put(PostGISGeo.millimeterToMeter.getURI(), MillimeterToMeter.class);
            functionRegistry.put(PostGISGeo.nauticalMileToMeter.getURI(), NauticalMileToMeter.class);
            functionRegistry.put(PostGISGeo.USFootToMeter.getURI(), USFootToMeter.class);
            functionRegistry.put(PostGISGeo.USInchToMeter.getURI(), USInchToMeter.class);
            functionRegistry.put(PostGISGeo.USMileToMeter.getURI(), USMileToMeter.class);
            functionRegistry.put(PostGISGeo.USYardToMeter.getURI(), USYardToMeter.class);
            functionRegistry.put(PostGISGeo.yardToMeter.getURI(), YardToMeter.class);
