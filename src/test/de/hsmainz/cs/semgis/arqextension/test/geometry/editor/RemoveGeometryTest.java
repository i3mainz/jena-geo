...
public class RemoveGeometryTest {
	...
	public void testRemoveGeometry() {
        NodeValue geometryLiteral = NodeValue.makeNode(result, WKTDatatype.INSTANCE);
        NodeValue index = NodeValue.makeInteger(3);
        RemoveGeometry instance=new RemoveGeometry();
        NodeValue expResult = NodeValue.makeNode(testGeom2, WKTDatatype.INSTANCE);
        NodeValue result = instance.exec(geometryLiteral,index);
